...
namespace CensusTesting
{
    public class Tests
    {
        ...
        public void GivenIndianCensusDataFile_WhenReaded_ShouldReturnCensusDataCount()
        {
            ...
            stateRecord = censusAnalyzer.LoadCensusData(indianStateCodeFilePath, Country.INDIA, indianStateCodeHeaders);
        ...
        public void GivenWrongIndianCensusDataFile_WhenReaded_ShouldReturnCustomException()
        {
            ...
            var stateException = Assert.Throws<CensusAnalyzerException>(() => censusAnalyzer.LoadCensusData(wrongHeaderStateCodeFilePath, Country.INDIA, indianStateCodeHeaders));
        ...
        public void GivenWrongIndianCensusDataFileType_WhenReaded_ShouldReturnCustomException()
        {
            ...
            var stateException = Assert.Throws<CensusAnalyzerException>(() => censusAnalyzer.LoadCensusData(wrongIndianStateCodeFileType, Country.INDIA, indianStateCodeHeaders));
            Assert.AreEqual(CensusAnalyzerException.ExceptionType.INVALID_FILE_TYPE, stateException.eType);
        ...
        public void GivenCorrectIndianCensusDataFileButWrongDelimeter_WhenReaded_ShouldReturnCustomException()
        {
            ...
            var stateException = Assert.Throws<CensusAnalyzerException>(() => censusAnalyzer.LoadCensusData(delimiterIndianStateCodeFilePath, Country.INDIA, indianStateCodeHeaders));
            Assert.AreEqual(CensusAnalyzerException.ExceptionType.INCORRECT_DELIMITER, stateException.eType);
        ...
        public void GivenCorrectIndianCensusDataFileButWrongCsvHeader_WhenReaded_ShouldReturnCustomException()
        {
            ...
            var stateException = Assert.Throws<CensusAnalyzerException>(() => censusAnalyzer.LoadCensusData(delimiterIndianStateCodeFilePath, Country.INDIA, wrongIndianStateCodeHeaders));
            Assert.AreEqual(CensusAnalyzerException.ExceptionType.INCORRECT_HEADER, stateException.eType);
        }
    }
}